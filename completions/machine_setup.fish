...
complete -c machine_setup -n "__fish_use_subcommand" -s h -l help -d 'Print help information'
complete -c machine_setup -n "__fish_use_subcommand" -s V -l version -d 'Print version information'
...
complete -c machine_setup -n "__fish_seen_subcommand_from install" -s h -l help -d 'Print help information'
complete -c machine_setup -n "__fish_seen_subcommand_from install" -s V -l version -d 'Print version information'
...
complete -c machine_setup -n "__fish_seen_subcommand_from update" -s h -l help -d 'Print help information'
complete -c machine_setup -n "__fish_seen_subcommand_from update" -s V -l version -d 'Print version information'
...
complete -c machine_setup -n "__fish_seen_subcommand_from uninstall" -s h -l help -d 'Print help information'
complete -c machine_setup -n "__fish_seen_subcommand_from uninstall" -s V -l version -d 'Print version information'
...
complete -c machine_setup -n "__fish_seen_subcommand_from list" -s h -l help -d 'Print help information'
complete -c machine_setup -n "__fish_seen_subcommand_from list" -s V -l version -d 'Print version information'
...
complete -c machine_setup -n "__fish_seen_subcommand_from help" -s c -l config -d 'path to the config file' -r
complete -c machine_setup -n "__fish_seen_subcommand_from help" -s t -l task -d 'run a single task' -r
complete -c machine_setup -n "__fish_seen_subcommand_from help" -s l -l level -d 'Set log level' -r
complete -c machine_setup -n "__fish_seen_subcommand_from help" -s s -l select -d 'Select a task to run'
complete -c machine_setup -n "__fish_seen_subcommand_from help" -s d -l debug -d 'Add debug information'
